...
<li>
    ...
    <p className="text-base md:text-xl text-gray-300 max-w-2xl mx-auto mb-8">
        ...
        accessible products for digital and financial growth, with integrated artificial intelligence.
    </p>

    <a
        href="#"
            className="group flex items-center px-10 py-4 rounded-2xl border border-white/20 bg-white
            hover:bg-gray-300 transition-colors duration-200 focus:outline-none shadow-lg"
        aria-label="Start Deploying with Kivoff"
    >
        <span className="text-black text-2xl font-bold mr-8">
        Start Deploying 
        </span>
        <span className="flex items-center justify-center w-12 h-12 rounded-full bg-">
            <img
                src="/Logo.svg"
                alt="Kivoff Logo"
